...
for (i in seq_along(attributes)){
    ...
    print(paste("Read", attr, "forecast and interpolate to station locations:"))
    ...
    for(filename in fc_files){
        ...
        for(thisst in stationlist){
            ...
            for(vtime in fc_raw_validtime_append){
                ...
                fc_interpolated_append[thisst_pos, , vtime_pos] <- fc_raw_att[lon_pos_mindiff, lat_pos_mindiff, , fc_time_pos]
            }
        }
