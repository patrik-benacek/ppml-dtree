...
class QuantileExtraTreesRegressor:
    """A quantile extra trees regressor based on the scikit-learn ExtraTreesRegressor
    
    A wrapper around the ExtraTreesRegressor which summarizes based on quantiles rather than
    the mean. Note that quantile predicitons take much longer than mean predictions.
    ...
    nthreads : int, default=1
        number of threads to used
    rf_kwargs : array or array like
        kwargs to be passed to the ExtraTreesRegressor 
    
    See Also
    --------
    https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.ExtraTreesRegressor.html#sklearn.ensemble.ExtraTreesRegressor.apply
    """
    def __init__(self, nthreads=1, **rf_kwargs):
        rf_kwargs['n_jobs'] = nthreads
        self.forest = ExtraTreesRegressor(**rf_kwargs)
        set_num_threads(nthreads)
    ...
    def apply(self, X):
        """
        wrapper for sklearn.ensemble.ExtraTreesRegressor.apply
    ...
    def decision_path(self, X):
        """
        wrapper for sklearn.ensemble.ExtraTreesRegressor.decision_path
    ...
    def set_params(self, **params):
        """
        wrapper for sklearn.ensemble.ExtraTreesRegressor.set_params
